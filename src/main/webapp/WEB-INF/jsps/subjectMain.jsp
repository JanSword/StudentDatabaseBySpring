    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <a class="btn btn-sm btn-info" href="addSubjectPrompt">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="simple-table" class="table table-striped table-bordered table-hover row text-center">
                                    <thead>
                                    <tr>
                                        <th style="width: 20%" class="text-center">课程编号</th>
                                        <th style="width: 30%" class="text-center">课程名称</th>
                                        <th style="width: 15%" class="text-center">选修人数</th>
                                    ...
                                    <tbody>
                                        <c:forEach var="Object" items="${subjects}">
                                            <tr>
                                                <td>${Object.subjectid}</td>
                                                <td>${Object.subjectname}</td>
                                                <td>${Object.electivenum}</td>
                                                <td>${Object.subjectavg}</td>
                                                <td>
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <a class="btn btn-sm btn-warning" href="updateSubjectPrompt?subjectid=${Object.subjectid}">修改</a>
                                                        <a class="btn btn-sm btn-danger" href="deleteSubject?subjectid=${Object.subjectid}" onclick="return fn()">删除</a>
                                                        <a class="btn btn-sm btn-grey" href="refreshSubject?page=${subjectPage.number+1}&subjectid=${Object.subjectid}">刷新</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        ...
                                        <div class="dataTables_paginate paging_simple_numbers"
                                            ...
                                            <ol class="pagination">
                                                <li class="paginate_button " aria-controls="dynamic-table" tabindex="0">
                                                    <input type="button" value="首页" class="btn  btn-purple" onclick="javascript:top.location.href='subjectMain?page=1'"/>
                                                </li>
                                                <li class="paginate_button" aria-controls="dynamic-table" tabindex="0" id="dynamic-table_previous">
                                                    <input type="button" value="上一页" class="btn  btn-purple" onclick="javascript:top.location.href='subjectMain?page=${subjectPage.number}'"/>
                                                </li>
                                                <li class="paginate_button next" aria-controls="dynamic-table" tabindex="0" id="dynamic-table_next">
                                                    <input type="button" value="下一页" class="btn  btn-purple" onclick="javascript:top.location.href='subjectMain?page=${subjectPage.number+2}'"/>
                                                </li>
                                                <li class="paginate_button " aria-controls="dynamic-table" tabindex="0">
                                                    <input type="button" value="末页" class="btn  btn-purple" onclick="javascript:top.location.href='subjectMain?page=${subjectPage.totalPages}'"/>
                                                </li>
...
<script type="text/javascript">
    ...
    function changePage(p) {
        window.location.href="subjectMain?page="+p;
    }
    function jump() {
