...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/bootstrap-datepicker3.css"/>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row clearfix">
                                ...
                                <form method="post" action="doUpload" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                <img  width="150:px" height="200:px" src="${pageContext.request.contextPath}/Images/${student.img}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                <h4 class="widget-title" style="text-align: center">头像上传
                                                    <input
                                                        style="border:0px;background:none; text-align: center"
                                                        name="studentid"
                                                        value="${student.studentid}" readonly="true">
                                                    <%--<a style="text-decoration: none;text-align: center" name="studentid">${student.studentid}</a>--%>
                                                </h4>
                                            </div>
                            ...
                            <div class="col-md-8">
                                <form action="updateStudent" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="studentid" id="form-field-1"
                                                   value="${student.studentid}"
                                                   class="col-xs-10 col-sm-7" readonly="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input checked type="radio" name="sex" value="男">男</input>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="input-group">
                                                <input name="birthday" class="form-control date-picker"
                                                       value="${student.birthday}" id="id-date-picker-1" type="text"
                                                       data-date-format="dd-mm-yyyy" style="width: 200px"/>
                                                <i class="fa fa-calendar bigger-200"></i>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pregrade" value="${student.grade}" placeholder="班级"
                                                   class="col-xs-10 col-sm-7" readonly="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="grade">
                                                <c:forEach var="Object" items="${gradeids}">
                                                    <option value="${Object}">
                                                            ${Object}
                                                    </option>
                                                </c:forEach>
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            &nbsp; &nbsp; &nbsp;
                                            <button class="btn btn-warning" type="submit" formaction="studentMain">
