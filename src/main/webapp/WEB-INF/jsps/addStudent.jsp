        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="addStudent" class="form-horizontal" role="form" enctype="multipart/form-data" method="post">
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="widget-box">
                                        <div class="widget-header">
                                            <h4 class="widget-title" style="text-align: center">头像上传</h4>
                                        </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="studentid" id="form-field-1" value="2017"
                                                   placeholder="2017****" class="col-xs-10 col-sm-7"/>
                                            <label class="col-sm-3 control-label no-padding-right "
                                                   style="color: #a51f1c" for="form-field-1"> ${notice} </label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="name" placeholder="姓名" class="col-xs-10 col-sm-7"/>
                                        </div>
                                    </div>
