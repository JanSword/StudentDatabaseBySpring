        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="updateGrade" class="form-horizontal" role="form">
                            <!-- #section:elements.form -->
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 您要修改的班级编号是 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="gradeid" id="form-field-1" value="${grade.gradeid}" class="col-xs-10 col-sm-5" readonly="true" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 请输入班级名称 </label>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    &nbsp; &nbsp; &nbsp;
                                    <button class="btn btn-warning" type="submit"  formaction="gradeMain">
