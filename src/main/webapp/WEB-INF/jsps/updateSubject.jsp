        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="updateSubject" class="form-horizontal" role="form">
                            <!-- #section:elements.form -->

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 您要修改的课程编号是 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="subjectid"  value="${subject.subjectid}" class="col-xs-10 col-sm-5" readonly="true" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 请输入课程名称 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="subjectname" id="form-field-1" value="${subject.subjectname}" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    &nbsp; &nbsp; &nbsp;
                                    <button class="btn btn-warning" type="submit" formaction="subjectMain">
