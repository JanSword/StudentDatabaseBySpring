...
<head>
    ...
    <script>
        function fn(){
            if(confirm("确定要选择该课程吗？（请慎重！选择后无法删除！）")){
            }else{
                return false;
            }
        }
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <h2>
                            亲爱的${student.name}同学您好！,欢迎进入选课系统！
                        </h2>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="simple-table" class="table table-striped table-bordered table-hover row text-center">
                                    <thead>
                                    <tr>
                                        <th style="width: 30%" class="text-center">课程编号</th>
                                        <th style="width: 30%" class="text-center">课程名称</th>
                                        <th style="width: 40%" class="text-center">操作</th>
                                    </tr>
                                    </thead>

                                    <tbody>
                                    <c:forEach var="Object" items="${sbjs}">
                                        <tr>
                                            <td>${Object.subjectid}</td>
                                            <td>${Object.subjectname}</td>
                                            <td>
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    <a class="btn ${scoreService.checkHaveElectivedOfAble(student.studentid,Object.subjectid)} btn-sm btn-${scoreService.checkHaveElectivedOfColor(student.studentid,Object.subjectid)}" href="addScore?subjectid=${Object.subjectid}&studentid=${student.studentid}" onclick="return fn()">${scoreService.checkHaveElectivedOfString(student.studentid,Object.subjectid)}</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                        ...
                                        <div class="dataTables_paginate paging_simple_numbers"
                                            ...
                                            <ol class="pagination">
                                                <li class="paginate_button " aria-controls="dynamic-table" tabindex="0">
                                                    <input type="button" value="首页" class="btn  btn-purple" onclick="javascript:top.location.href='addScoreMain?page=1&studentid=${student.studentid}'"/>
                                                </li>
                                                <li class="paginate_button" aria-controls="dynamic-table" tabindex="0" id="dynamic-table_previous">
                                                    <input type="button" value="上一页" class="btn  btn-purple" onclick="javascript:top.location.href='addScoreMain?page=${subjectPage.number}&studentid=${student.studentid}'"/>
                                                </li>
                                                <li class="paginate_button next" aria-controls="dynamic-table" tabindex="0" id="dynamic-table_next">
                                                    <input type="button" value="下一页" class="btn  btn-purple" onclick="javascript:top.location.href='addScoreMain?page=${subjectPage.number+2}&studentid=${student.studentid}'"/>
                                                </li>
                                                <li class="paginate_button " aria-controls="dynamic-table" tabindex="0">
                                                    <input type="button" value="末页" class="btn  btn-purple" onclick="javascript:top.location.href='addScoreMain?page=${subjectPage.totalPages}&studentid=${student.studentid}'"/>
                                                </li>
                                                ${subjectPage.number+1}/${subjectPage.totalPages}
                                                <input type="number" max="${subjectPage.totalPages}" min="1" style="width:50px" id="jump" value="1"/>
...
<script type="text/javascript">
    ...
    function changePage(p) {
        window.location.href="addScoreMain?page="+p+"&studentid=${student.studentid}";
    }
    function jump() {
