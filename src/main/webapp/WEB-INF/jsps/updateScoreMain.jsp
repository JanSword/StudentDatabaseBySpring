...
<head>
    ...
    <![endif]-->
    <script src="${pageContext.request.contextPath}/resources/checkScore.js"></script>
</head>
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <h2>
                            管理员您好！您将对${student.name}同学进行分数录入！
                        </h2>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                    <table id="simple-table" class="table table-striped table-bordered table-hover row text-center" >
                                        <thead>
                                        <tr>
                                            <th style="width: 10%" class="text-center">选课编号</th>
                                            <th style="width: 20%" class="text-center">学号</th>
                                            <th style="width: 10%" class="text-center">课程编号</th>
                                            <th style="width: 20%" class="text-center">课程名称</th>
                                            <th style="width: 10%" class="text-center">当前分数</th>
                                            <th style="width: 10%" class="text-center">录入分数</th>
                                            <th style="width: 20%" class="text-center">操作</th>
                                        </tr>
                                        </thead>

                                        <tbody>
                                        <c:forEach var="Object" items="${scores}">
                                        <form action="updateScore" class="form-horizontal" role="form">
                                            <tr>
                                                <td>
                                                    <label>
                                                        <input style="width: 60px; border: none" name="id" class="text-center"
                                                               value="${Object.id}" type="text" readonly="true">
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input style="width: 100px; border: none" name="studentid" class="text-center"
                                                               value="${student.studentid}" type="text" readonly="true">
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input style="width: 60px; border: none" name="subjectid" class="text-center"
                                                               type="text" value="${Object.subjectid}" readonly="true">
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input style=" border: none" class="text-center"
                                                               type="text" value=" ${subjectService.getSubjectBySubjectid(Object.subjectid).subjectname}" readonly="true">
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input style="width: 60px; border: none" class="text-center"
                                                               type="text"
                                                               value="${Object.score}" readonly="true">
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input type="number" name="score" id="score" max="100" min="1" class="text-center"
                                                               value="0" oninput="checkScore()">
                                                    </label>
                                                </td>
                                                <td>
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <button class="btn btn-sm btn-warning"
                                                           type="submit">录入</button>
                                                    </div>
                                                </td>
