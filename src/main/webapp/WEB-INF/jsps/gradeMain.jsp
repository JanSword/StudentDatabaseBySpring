...
<head>
    ...
    <script>
        function fn(){
            if(confirm("确定要删除该班级信息吗？（如该班仍有学生则无法删除，删除前请将该班同学转移至其他班！）")){
            }else{
                return false;
            }
        }
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <a class="btn btn-sm btn-info" href="addGradePrompt">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="simple-table" class="table table-striped table-bordered table-hover row text-center">
                                    <thead>
                                    <tr>
                                        <th style="width: 20%" class="text-center">班级编号</th>
                                        <th style="width: 30%" class="text-center">班级名称</th>
                                        <th style="width: 15%" class="text-center">学生人数</th>
                                        <th style="width: 15%" class="text-center">平均分</th>
                                        <th style="width: 20%" class="text-center">操作</th>
                                    </tr>
                                    </thead>

                                    <tbody>
                                    <c:forEach var="Object" items="${grades}">
                                        <tr>
                                            <td>${Object.gradeid}</td>
                                            <td>${Object.gradename}</td>
                                            <td>${Object.studentnum}</td>
                                            <td>${Object.gradeavg}</td>
                                            <td>
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    <a class="btn btn-sm btn-warning" href="updateGradePrompt?gradeid=${Object.gradeid}">修改</a>
                                                    <a class="btn btn-sm btn-danger" href="deleteGrade?gradeid=${Object.gradeid}" onclick="return fn()">删除</a>
                                                    <a class="btn btn-sm btn-grey" href="refreshGrade?page=${gradePage.number+1}&gradeid=${Object.gradeid}">刷新</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                        ...
                                        <div class="dataTables_paginate paging_simple_numbers"
                                            ...
                                            <ol class="pagination">
                                                <li class="paginate_button " aria-controls="dynamic-table" tabindex="0">
                                                    <input type="button" value="首页" class="btn  btn-purple" onclick="javascript:top.location.href='gradeMain?page=1'"/>
                                                    <%--<a href="subjectMain?page=1">首页</a>--%>
                                                </li>
                                                <li class="paginate_button" aria-controls="dynamic-table" tabindex="0" id="dynamic-table_previous">
                                                    <%--<a href="subjectMain?page=${subjectPage.number}">上一页</a>--%>
                                                    <input type="button" value="上一页" class="btn  btn-purple" onclick="javascript:top.location.href='gradeMain?page=${gradePage.number}'"/>
                                                </li>
                                                <%--<li class="paginate_button active" aria-controls="dynamic-table"--%>
                                                <%--tabindex="0"><a href="#">1</a></li>--%>
                                                <li class="paginate_button next" aria-controls="dynamic-table" tabindex="0" id="dynamic-table_next">
                                                    <%--<a href="subjectMain?page=${subjectPage.number+2}">下一页</a>--%>
                                                    <input type="button" value="下一页" class="btn  btn-purple" onclick="javascript:top.location.href='gradeMain?page=${gradePage.number+2}'"/>
                                                </li>
                                                <li class="paginate_button " aria-controls="dynamic-table" tabindex="0">
                                                    <%--<a href="subjectMain?page=${subjectPage.totalPages}">末页</a>--%>
                                                    <input type="button" value="末页" class="btn  btn-purple" onclick="javascript:top.location.href='gradeMain?page=${gradePage.totalPages}'"/>
                                                </li>
                                                ${gradePage.number+1}/${gradePage.totalPages}
                                                <input type="number" max="${gradePage.totalPages}" min="1" style="width:50px" id="jump" value="1"/>
...
<script type="text/javascript">
    ...
    function changePage(p) {
        window.location.href="gradeMain?page="+p;
    }
    function jump() {
